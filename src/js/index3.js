...
import { preloadImages } from './utils3.js';
// Importing StackMotionEffect classes from different effect files with renamed imports to avoid name conflicts
import { StackMotionEffect as StackMotionEffect1 } from './effect-1/stackMotionEffect';
import { StackMotionEffect as StackMotionEffect2 } from './effect-2/stackMotionEffect';
import { StackMotionEffect as StackMotionEffect3 } from './effect-3/stackMotionEffect';
