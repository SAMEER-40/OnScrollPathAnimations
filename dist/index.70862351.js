...
closeCtrl.addEventListener("click", ()=>{
    ...
    (0, _gsap.gsap).timeline({
        ...
        onStart: ()=>body.classList.remove("oh23"),
        onComplete: ()=>{
...
Promise.all([
    (0, _utils2.preloadImages)(".cell__img-inner"),
    (0, _utils2.preloadFonts)("gdf6msi")
]).then(()=>{
...
class Row {
	 ...
	 */ constructor(DOM_el, DOM_previewItem){
        ...
        this.DOM.title = this.DOM.titleWrap.querySelector(".oh23__inner");
...
class PreviewItem {
	 ...
	 */ constructor(DOM_el){
        this.DOM.el = DOM_el;
        this.DOM.title = this.DOM.el.querySelector(".preview__item-title > .oh23__inner");
        this.DOM.grid = this.DOM.el.querySelector(".grid33");
        this.DOM.images = [
